...
function App() {
  return (
    ...
    <header class="main-banner-about">
       <div class="overl"></div>
       <div class="title">
         <h1>I'm Sanjana K S</h1><hr class="hr"/>
         <h2>Photographer</h2>
       </div>
    </header>
    ...
    <section class="main-section-about">
      ...
      <div class="about-me">
         <div class="about">
            ...
            <p>My name is Sanjana K S  I photograph with heart and soul and love to make people happy with my photos!
